  ...
  return (
    <>
      ...
      <ContactModal
        ...
        defaultMessage={language === 'vi'
          ? `Tôi quan tâm đến sản phẩm: ${name} (Mã: ${product.itemNo}). Vui lòng gửi báo giá và thông tin chi tiết.`
          : `I'm interested in: ${name} (Item: ${product.itemNo}). Please send me a quote and detailed information.`
        }
      />
    </>
  );
