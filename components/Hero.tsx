...
export const Hero: React.FC = () => {
  ...
  return (
    <div id="home" className="relative flex-1 min-h-0 flex items-center justify-center overflow-hidden bg-primary">
      {/* Background Image with Overlay */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/hero-bg.jpg"
          alt="VIDO Furniture - Storage ottomans and seating collection"
          fill
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        <div className="mb-6 inline-block px-4 py-1.5 border border-accent/50 rounded-full bg-black/40 backdrop-blur-sm">
          <span className="text-accent text-[10px] sm:text-xs font-bold tracking-[0.2em] uppercase">{t.hero.badge}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center max-w-xs sm:max-w-none mx-auto">
          <Button
            variant="primary"
            className="w-full sm:w-auto px-10 py-4 text-xs sm:text-sm tracking-[0.2em] font-bold"
          ...
          <Button
            variant="outline"
            className="w-full sm:w-auto px-10 py-4 border-white text-white hover:bg-white hover:text-primary tracking-[0.2em] font-bold"
