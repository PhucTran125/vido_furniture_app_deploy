export const translations = {
  en: {
    ...
    blog: {
      ...
      title: 'Our Blog',
      readMore: 'Read More',
      featuredBadge: 'News & Insights',
      featuredTitle: 'Latest from the Blog',
      featuredDesc: 'Discover our latest thoughts on furniture manufacturing, industry trends, and design innovation.',
      viewAll: 'View All Articles',
      author: 'Written by',
      share: 'Share Article',
      back: 'Back to Blog',
      noPosts: 'No posts yet',
      noPostsDesc: 'Check back soon for our latest updates and articles.',
    },
    featured: {
  ...
  vi: {
    ...
    blog: {
      ...
      title: 'Blog',
      readMore: 'Xem Thêm',
      featuredBadge: 'Tin Tức & Thông Tin',
      featuredTitle: 'Bài Viết Mới Nhất',
      featuredDesc: 'Khám phá những suy nghĩ mới nhất của chúng tôi về sản xuất nội thất, xu hướng ngành và đổi mới thiết kế.',
      viewAll: 'Xem Tất Cả Bài Viết',
      author: 'Được viết bởi',
      share: 'Chia Sẻ Bài Viết',
      back: 'Quay Lại Blog',
      noPosts: 'Chưa có bài viết',
      noPostsDesc: 'Vui lòng quay lại sau để xem các bài viết mới nhất.',
    },
    featured: {
